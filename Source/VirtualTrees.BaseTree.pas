...
uses
  Winapi.Windows, Winapi.Messages, Winapi.ActiveX, Winapi.CommCtrl, Winapi.UxTheme, Winapi.ShlObj, System.SysUtils, System.Classes,
  System.Types, Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.ImgList, Vcl.StdCtrls, Vcl.Menus, Vcl.Printers, Vcl.Themes, System.UITypes,
  // some types moved from Vcl.* to System.UITypes
  VirtualTrees.Types, VirtualTrees.Colors, VirtualTrees.DragImage, VirtualTrees.Header
  {$ifdef VT_FMX}
...
type
  ...
  TVTCheckChangingEvent = procedure(Sender : TBaseVirtualTree; Node : PVirtualNode; var NewState : TCheckState; var Allowed : Boolean)
    of object;
  ...
  TVTEditChangingEvent = procedure(Sender : TBaseVirtualTree; Node : PVirtualNode; Column : TColumnIndex; var Allowed : Boolean) of object;
  ...
  TVTFocusChangingEvent = procedure(Sender : TBaseVirtualTree; OldNode, NewNode : PVirtualNode; OldColumn, NewColumn : TColumnIndex;
  ...
  TVTInitNodeEvent = procedure(Sender : TBaseVirtualTree; ParentNode, Node : PVirtualNode; var InitialStates : TVirtualNodeInitStates)
    of object;
  ...
  TVTHelpContextEvent = procedure(Sender : TBaseVirtualTree; Node : PVirtualNode; Column : TColumnIndex; var HelpContext : Integer)
    of object;
  TVTCreateEditorEvent = procedure(Sender : TBaseVirtualTree; Node : PVirtualNode; Column : TColumnIndex; out EditLink : IVTEditLink)
    of object;
  ...
  TVTHeaderPaintEvent = procedure(Sender : TVTHeader; HeaderCanvas : TCanvas; Column : TVirtualTreeColumn; R : TRect;
    Hover, Pressed : Boolean; DropMark : TVTDropMarkMode) of object;
  TVTHeaderPaintQueryElementsEvent = procedure(Sender : TVTHeader; var PaintInfo : THeaderPaintInfo; var Elements : THeaderPaintElements)
    of object;
  TVTAdvancedHeaderPaintEvent = procedure(Sender : TVTHeader; var PaintInfo : THeaderPaintInfo; const Elements : THeaderPaintElements)
    of object;
  ...
  TVTColumnCheckChangingEvent = procedure(Sender : TVTHeader; Column : TColumnIndex; var NewState : TCheckState; var Allowed : Boolean)
    of object;
  ...
  TVTColumnWidthTrackingEvent = procedure(Sender : TVTHeader; Column : TColumnIndex; Shift : TShiftState; var TrackPoint : TPoint;
  ...
  // -- CUSTOM CODE
  TVTColumnSortingevent = procedure(Sender : TBaseVirtualTree; Column : TColumnIndex; var AIsSorted : Boolean;
    var ASortDirection : TSortDirection) of object;
  //
  ...
  TVTNodeHeightDblClickResizeEvent = procedure(Sender : TBaseVirtualTree; Node : PVirtualNode; Column : TColumnIndex; Shift : TShiftState;
    P : TPoint; var Allowed : Boolean) of object;
  TVTCanSplitterResizeNodeEvent = procedure(Sender : TBaseVirtualTree; P : TPoint; Node : PVirtualNode; Column : TColumnIndex;
    var Allowed : Boolean) of object;
  ...
  TVTDragAllowedEvent = procedure(Sender : TBaseVirtualTree; Node : PVirtualNode; Column : TColumnIndex; var Allowed : Boolean) of object;
  ...
  TVTDragDropEvent = procedure(Sender : TBaseVirtualTree; Source : TObject; DataObject : TVTDragDataObject; Formats : TFormatArray;
    Shift : TShiftState; Pt : TPoint; var Effect : Integer; Mode : TDropMode) of object;
  ...
  TVTBeforeItemPaintEvent = procedure(Sender : TBaseVirtualTree; TargetCanvas : TCanvas; Node : PVirtualNode; ItemRect : TRect;
  ...
  TVTBeforeCellPaintEvent = procedure(Sender : TBaseVirtualTree; TargetCanvas : TCanvas; Node : PVirtualNode; Column : TColumnIndex;
    CellPaintMode : TVTCellPaintMode; CellRect : TRect; var ContentRect : TRect) of object;
  TVTAfterCellPaintEvent = procedure(Sender : TBaseVirtualTree; TargetCanvas : TCanvas; Node : PVirtualNode; Column : TColumnIndex;
    CellRect : TRect) of object;
  ...
  TVTMeasureItemEvent = procedure(Sender : TBaseVirtualTree; TargetCanvas : TCanvas; Node : PVirtualNode; var NodeHeight : TDimension)
    of object;

  TVTPrepareButtonImagesEvent = procedure(Sender : TBaseVirtualTree; const APlusBM : TBitmap; const APlusHotBM : TBitmap;
    const APlusSelectedHotBM : TBitmap; const AMinusBM : TBitmap; const AMinusHotBM : TBitmap; const AMinusSelectedHotBM : TBitmap;
    var ASize : TSize) of object;

  // search, sort
  TVTCompareEvent = procedure(Sender : TBaseVirtualTree; Node1, Node2 : PVirtualNode; Column : TColumnIndex; var Result : Integer)
    of object;
  TVTIncrementalSearchEvent = procedure(Sender : TBaseVirtualTree; Node : PVirtualNode; const SearchText : string; var Result : Integer)
    of object;
  ...
  TVTDrawHintEvent = procedure(Sender : TBaseVirtualTree; HintCanvas : TCanvas; Node : PVirtualNode; R : TRect; Column : TColumnIndex)
    of object;
  ...
  TVTKeyActionEvent = procedure(Sender : TBaseVirtualTree; var CharCode : Word; var Shift : TShiftState; var DoDefault : Boolean) of object;
  ...
  TVTGetCellIsEmptyEvent = procedure(Sender : TBaseVirtualTree; Node : PVirtualNode; Column : TColumnIndex; var IsEmpty : Boolean)
    of object;
  ...
  TVZVirtualNodeEnumerationMode = (vneAll, vneChecked, vneChild, vneCutCopy, vneInitialized, vneLeaf, vneLevel, vneNoInit, vneSelected,
    vneVisible, vneVisibleChild, vneVisibleNoInitChild, vneVisibleNoInit);
  ...
  private
    ...
    FHeader : TVTHeader;
    FRoot : PVirtualNode;
    FDefaultNodeHeight, FIndent : TDimension;
    ...
    FLastSelected, FFocusedNode : PVirtualNode;
    ...
    FLastSelRect, FNewSelRect : TRect; // used while doing draw selection
    ...
    FBackgroundOffsetX, FBackgroundOffsetY : TDimension; // used to fine tune the position of the background image
    ...
    FPlusBM, FMinusBM, // small bitmaps used for tree buttons
    FHotPlusBM, FHotMinusBM, FSelectedHotPlusBM, FSelectedHotMinusBM : TBitmap; // small bitmaps used for hot tree buttons
    ...
    FImageChangeLink, FStateChangeLink, FCustomCheckChangeLink : TChangeLink; // connections to the image lists
    ...
    FDragWidth, FDragHeight : Integer; // size of the drag image, the larger the more CPU power is needed
    ...
    FRangeX, FRangeY : TDimension; // current virtual width and height of the tree
    ...
    FNextNodeToSelect : PVirtualNode;
    // Next tree node that we would like to select if the current one gets deleted or looses selection for other reasons.
    ...
    FOnHeaderMouseDown, FOnHeaderMouseUp : TVTHeaderMouseEvent;
    ...
    // -- CUSTOM CODE
    FOnAdjustAutoSize: TVTAdjustAutoSize;
    // --
    ...
    function CollectSelectedNodesLTR(MainColumn : Integer; NodeLeft, NodeRight : TDimension; Alignment : TAlignment;
      OldRect, NewRect : TRect) : Boolean;
    function CollectSelectedNodesRTL(MainColumn : Integer; NodeLeft, NodeRight : TDimension; Alignment : TAlignment;
      OldRect, NewRect : TRect) : Boolean;
    ...
    procedure PrepareBackGroundPicture(Source : TVTBackground; DrawingBitmap : TBitmap; DrawingBitmapWidth : TDimension;
      DrawingBitmapHeight : TDimension; ABkgcolor : TColor);
  ...
  protected
    ...
    procedure DoBeforeCellPaint(Canvas : TCanvas; Node : PVirtualNode; Column : TColumnIndex; CellPaintMode : TVTCellPaintMode;
    ...
    procedure DoCanSplitterResizeNode(P : TPoint; Node : PVirtualNode; Column : TColumnIndex; var Allowed : Boolean); virtual;
    ...
    function DoDragOver(Source : TObject; Shift : TShiftState; State : TDragState; Pt : TPoint; Mode : TDropMode; var Effect : Integer)
      : Boolean; virtual;
    procedure DoDragDrop(Source : TObject; const DataObject : TVTDragDataObject; const Formats : TFormatArray; Shift : TShiftState;
      Pt : TPoint; var Effect : Integer; Mode : TDropMode); virtual;
    ...
    procedure DoGetHintKind(Node : PVirtualNode; Column : TColumnIndex; var Kind : TVTHintKind);
    function DoGetImageIndex(Node : PVirtualNode; Kind : TVTImageKind; Column : TColumnIndex; var Ghosted : Boolean;
      var Index : TImageIndex) : TCustomImageList; virtual;
    ...
    function DoNodeHeightDblClickResize(Node : PVirtualNode; Column : TColumnIndex; Shift : TShiftState; P : TPoint) : Boolean; virtual;
    function DoNodeHeightTracking(Node : PVirtualNode; Column : TColumnIndex; Shift : TShiftState; var TrackPoint : TPoint; P : TPoint)
      : Boolean; virtual;
    ...
    function DragDrop(const DataObject : TVTDragDataObject; KeyState : Integer; Pt : TPoint; var Effect : Integer) : HResult;
      reintroduce; virtual;
    function DragEnter(KeyState : Integer; Pt : TPoint; var Effect : Integer) : HResult; virtual;
    procedure DragFinished; virtual;
    procedure DragLeave; virtual;
    function DragOver(Source : TObject; KeyState : Integer; DragState : TDragState; Pt : TPoint; var Effect : Integer) : HResult;
      reintroduce; virtual;
    ...
    function GetCheckImage(Node : PVirtualNode; ImgCheckType : TCheckType = ctNone; ImgCheckState : TCheckState = csUncheckedNormal;
      ImgEnabled : Boolean = True) : Integer; virtual;
    ...
    function GetImageSize(Node : PVirtualNode; Kind : TVTImageKind = TVTImageKind.ikNormal; Column : TColumnIndex = 0;
      IncludePadding : Boolean = True) : TSize; virtual;
    ...
    procedure InternalDisconnectNode(Node : PVirtualNode; KeepFocus : Boolean; Reindex : Boolean = True;
      ParentClearing : Boolean = False); virtual;
    ...
    procedure PaintNodeButton(Canvas : TCanvas; Node : PVirtualNode; Column : TColumnIndex; const R : TRect; ButtonX, ButtonY : TDimension;
    ...
    procedure PaintSelectionRectangle(Target : TCanvas; WindowOrgX : TDimension; const SelectionRect : TRect; TargetRect : TRect); virtual;
    ...
    function ReadChunk(Stream : TStream; Version : Integer; Node : PVirtualNode; ChunkType, ChunkSize : Integer) : Boolean; virtual;
    ...
    procedure UpdateWindowAndDragImage(const Tree : TBaseVirtualTree; TreeRect : TRect; UpdateNCArea, ReshowDragImage : Boolean); virtual;
    ...
    property BackgroundOffsetX : TDimension index 0 read FBackgroundOffsetX write SetBackgroundOffset stored IsStored_BackgroundOffsetXY;
    // default 0;
    property BackgroundOffsetY : TDimension index 1 read FBackgroundOffsetY write SetBackgroundOffset stored IsStored_BackgroundOffsetXY;
    // default 0;
    ...
    property CheckImageKind : TCheckImageKind read FCheckImageKind write SetCheckImageKind stored False default ckSystemDefault;
    // deprecated, see issue #622
    ...
    property NextNodeToSelect : PVirtualNode read FNextNodeToSelect;
    // Next tree node that we would like to select if the current one gets deleted
    ...
    property RangeX : TDimension read GetRangeX;
    // Returns the width of the virtual tree in pixels, (not ClientWidth). If there are columns it returns the total width of all of them; otherwise it returns the maximum of the all the line's data widths.
    ...
    property OnAfterColumnWidthTracking : TVTAfterColumnWidthTrackingEvent read FOnAfterColumnWidthTracking
      write FOnAfterColumnWidthTracking;
    ...
    property OnGetHintKind : TVTHintKindEvent read FOnGetHintKind write FOnGetHintKind;
    ...
    property OnGetUserClipboardFormats : TVTGetUserClipboardFormatsEvent read FOnGetUserClipboardFormats write FOnGetUserClipboardFormats;
    ...
    property OnHeaderDrawQueryElements : TVTHeaderPaintQueryElementsEvent read FOnHeaderDrawQueryElements write FOnHeaderDrawQueryElements;
    property OnHeaderHeightTracking : TVTHeaderHeightTrackingEvent read FOnHeaderHeightTracking write FOnHeaderHeightTracking;
  ...
  public
    ...
    function CopyTo(Source : PVirtualNode; Tree : TBaseVirtualTree; Mode : TVTNodeAttachMode; ChildrenOnly : Boolean)
      : PVirtualNode; overload;
    function CopyTo(Source, Target : PVirtualNode; Mode : TVTNodeAttachMode; ChildrenOnly : Boolean) : PVirtualNode; overload;
    ...
    function GetFirstVisible(Node : PVirtualNode = nil; ConsiderChildrenAbove : Boolean = True; IncludeFiltered : Boolean = False)
      : PVirtualNode;
    ...
    function GetFirstVisibleNoInit(Node : PVirtualNode = nil; ConsiderChildrenAbove : Boolean = True; IncludeFiltered : Boolean = False)
      : PVirtualNode;
    ...
    function GetLastVisible(Node : PVirtualNode = nil; ConsiderChildrenAbove : Boolean = True; IncludeFiltered : Boolean = False)
      : PVirtualNode;
    ...
    function GetLastVisibleNoInit(Node : PVirtualNode = nil; ConsiderChildrenAbove : Boolean = True; IncludeFiltered : Boolean = False)
      : PVirtualNode;
    ...
    function GetNextChecked(Node : PVirtualNode; State : TCheckState = csCheckedNormal; ConsiderChildrenAbove : Boolean = False)
      : PVirtualNode; overload;
    ...
    procedure GetOffsets(pNode : PVirtualNode; out pOffsets : TVTOffsets; pElement : TVTElement = TVTElement.ofsEndOfClientArea;
      pColumn : Integer = NoColumn);
    function GetPrevious(Node : PVirtualNode; ConsiderChildrenAbove : Boolean = False) : PVirtualNode;
    function GetPreviousChecked(Node : PVirtualNode; State : TCheckState = csCheckedNormal; ConsiderChildrenAbove : Boolean = False)
      : PVirtualNode;
    ...
    procedure GetTextInfo(Node : PVirtualNode; Column : TColumnIndex; const AFont : TFont; var R : TRect; var Text : string); virtual;
    ...
    function ProcessDrop(const DataObject : TVTDragDataObject; TargetNode : PVirtualNode; var Effect : Integer; Mode : TVTNodeAttachMode)
      : Boolean;
    function ProcessOLEData(Source : TBaseVirtualTree; const DataObject : IDataObject; TargetNode : PVirtualNode; Mode : TVTNodeAttachMode;
      Optimized : Boolean) : Boolean;
    ...
    function VisibleNodes(Node : PVirtualNode = nil; ConsiderChildrenAbove : Boolean = True; IncludeFiltered : Boolean = False)
    ...
    function VisibleNoInitNodes(Node : PVirtualNode = nil; ConsiderChildrenAbove : Boolean = True; IncludeFiltered : Boolean = False)
      : TVTVirtualNodeEnumeration;
  ...
  TVTGetCellContentMarginEvent = procedure(Sender : TBaseVirtualTree; HintCanvas : TCanvas; Node : PVirtualNode; Column : TColumnIndex;
    CellContentMarginType : TVTCellContentMarginType; var CellContentMargin : TPoint) of object;
  TVTGetNodeWidthEvent = procedure(Sender : TBaseVirtualTree; HintCanvas : TCanvas; Node : PVirtualNode; Column : TColumnIndex;
    var NodeWidth : TDimension) of object;
...
uses
  ...
  System.Math, System.SyncObjs, System.StrUtils, Vcl.Consts, Vcl.AxCtrls, // TOLEStream
  Vcl.StdActns, // for standard action support
  Vcl.GraphUtil, // accessibility helper class
  VirtualTrees.StyleHooks, VirtualTrees.WorkerThread, VirtualTrees.ClipBoard, VirtualTrees.Utils, VirtualTrees.DragnDrop;
...
const
  ...
  // used for node allocation and access to internal data
...
type
  ...
  TToggleAnimationMode = (tamScrollUp, tamScrollDown, tamNoScroll);
  ...
  TToggleAnimationData = record
    ...
    R1, R2 : TRect; // animation rectangles
    Mode1, Mode2 : TToggleAnimationMode; // animation modes
...
begin
  WasValidating := (tsValidating in FStates) or (tsValidationNeeded in FStates);
  // Checking tsValidating is not enough, the TWorkerThread may be stuck in the first call to ChangeTreeStatesAsync()
...
begin
  ...
  begin
    ...
    repeat
      ...
      if not(vsVisible in Run.States) or (Run = FRoot) or (Run.Parent = nil) or not(vsExpanded in Run.Parent.States) then
        Break;
...
begin
  ...
  begin
    ...
    case FNodeAlignment of
      ...
      else if toShowButtons in FOptions.PaintOptions then
...
var
  Run : PVirtualNode;
  UncheckedCount, MixedCheckCount, CheckedCount : Cardinal;
      ...
      try
        ...
        try
          ...
          if (toAutoTristateTracking in FOptions.AutoOptions) and ([vsChecking, vsDisabled] * Parent.States = []) and
            (CheckType in [ctCheckBox, ctTriStateCheckBox]) and (Parent <> FRoot) and (Parent.CheckType = ctTriStateCheckBox) then
...
var
  Run, NextNode : PVirtualNode;
  TextRight, TextLeft, CurrentTop, CurrentRight, NextTop : TDimension;
  NextColumn, Dummy : Integer;
  ...
  begin
    ...
    repeat
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            repeat
              ...
              if (Dummy = InvalidColumn) or not ColumnIsEmpty(Run, Dummy) or (Items[Dummy].BidiMode <> bdLeftToRight) then
                Break;
              NextColumn := Dummy;
            until False;
        ...
        IsInOldRect := (OldRect.Left <= TextRight) and (OldRect.Right >= TextLeft) and (NextTop > OldRect.Top) and
          (CurrentTop < OldRect.Bottom);
        IsInNewRect := (NewRect.Left <= TextRight) and (NewRect.Right >= TextLeft) and (NextTop > NewRect.Top) and
          (CurrentTop < NewRect.Bottom);
      end;
...
var
  ...
  DummyRight, TextRight, TextLeft, CheckOffset, CurrentTop, CurrentLeft, NextTop, NodeWidth, MinY, MaxY : TDimension;
  IsInOldRect, IsInNewRect : Boolean;

  // quick check variables for various parameters
  WithCheck, WithStateImages, DoSwitch, AutoSpan : Boolean;
  SimpleSelection : Boolean;
      ...
      begin // The left column border might be extended if column spanning is enabled.
        ...
        begin
          ...
          repeat
            ...
            if (Dummy = InvalidColumn) or not ColumnIsEmpty(Run, Dummy) or (FHeader.Columns[Dummy].BidiMode = bdLeftToRight) then
              Break;
            NextColumn := Dummy;
          until False;
          if NextColumn = MainColumn then
        ...
        // Now determine whether we need to change the state.
        IsInOldRect := (OldRect.Right >= TextLeft) and (OldRect.Left <= TextRight) and (NextTop > OldRect.Top) and
          (CurrentTop < OldRect.Bottom);
        IsInNewRect := (NewRect.Right >= TextLeft) and (NewRect.Left <= TextRight) and (NextTop > NewRect.Top) and
          (CurrentTop < NewRect.Bottom);
      end;
...
procedure TBaseVirtualTree.ClearNodeBackground(const PaintInfo : TVTPaintInfo; UseBackground, Floating : Boolean; R : TRect);
  ...
  begin
    ...
    begin
      case EraseAction of
        ...
        begin
          if (poDrawSelection in PaintOptions) and (toFullRowSelect in FOptions.SelectionOptions) and (vsSelected in Node.States) and
            not(toUseBlendedSelection in FOptions.PaintOptions) and not(tsUseExplorerTheme in FStates) then
          begin
...
begin
  ...
  begin
    ...
    else if HasAsParent(Node2, Node1) then
      Result := IfThen(ConsiderChildrenAbove and (toChildrenAbove in FOptions.PaintOptions), 1, -1)
    else
    begin
...
begin
  Result := (toSyncCheckboxesWithSelection in FOptions.SelectionOptions) and (toCheckSupport in FOptions.MiscOptions) and
    Assigned(FCheckImages) and (Node.CheckType = ctCheckBox);
end;
...
procedure TBaseVirtualTree.GetOffsets(pNode : PVirtualNode; out pOffsets : TVTOffsets;
  pElement : TVTElement = TVTElement.ofsEndOfClientArea; pColumn : Integer = NoColumn);
...
begin
  ...
  begin
    ...
    Dec(pOffsets[TVTElement.ofsToggleButton], Divide((TDimension(FIndent) - FPlusBM.Width), 2) - 1 + FPlusBM.Width);
    // Compare PaintTree() relative line 107
    // checkbox
  ...
  if (toCheckSupport in TreeOptions.MiscOptions) and Assigned(FCheckImages) and (pNode.CheckType <> ctNone) and (pColumn = Header.MainColumn)
  then
  begin
  ...
  // End of text
  pOffsets[TVTElement.ofsRightOfText] := pOffsets[TVTElement.ofsText] + DoGetNodeWidth(pNode, pColumn) +
    DoGetNodeExtraWidth(pNode, pColumn);
...
begin
  Assert(GetCurrentThreadId = MainThreadId, 'UI controls may only be used in UI thread.');
  // FUpdateCount is not thread-safe! So do not write it in non-UI threads.
...
procedure TBaseVirtualTree.HandleClickSelection(LastFocused, NewNode : PVirtualNode; Shift : TShiftState; DragPending : Boolean);
...
begin
  ...
  begin
    ...
    begin
      ...
      else if vsSelected in NewNode.States then
...
begin
  ...
  begin
    if NeedButtons then
    begin
      if StyleServices.GetElementSize(FPlusBM.Canvas.Handle, StyleServices.GetElementDetails(tcbCategoryGlyphClosed), TElementSize.esActual,
        Size) then
      begin
        Size.cx := Max(Size.cx, cMinExpandoHeight); // Use min size of 11, see issue #1035 / RSP-33715
        Size.cx := ScaledPixels(Size.cx)
        // I would have expected that the returned value is dpi-sclaed, but this is not the case in RAD Studio 10.4.1. See issue #984
      end
      else
      ...
      StyleServices.DrawElement(FPlusBM.Canvas.Handle, StyleServices.GetElementDetails(tcbCategoryGlyphClosed), R
        {$if CompilerVersion >= 34}, nil, FCurrentPPI{$ifend});
...
begin
  ...
  begin
    ...
    DoSetOffsetXY(Point(FOffsetX, FOffsetY + ClientHeight - R.Top - NodeHeight[Node]), [suoRepaintScrollBars, suoUpdateNCArea]);
  end;
end;
...
begin
  ...
  begin
    ...
    if (toAutoTristateTracking in FOptions.AutoOptions) and (Value in [ctCheckBox, ctTriStateCheckBox]) and (Node.Parent <> FRoot) then
    begin
      if not(vsInitialized in Node.Parent.States) then
        InitNode(Node.Parent);
      if (Node.Parent.CheckType = ctTriStateCheckBox) then
      begin
...
begin
  if (FFocusedColumn <> Value) and DoFocusChanging(FFocusedNode, FFocusedNode, FFocusedColumn, Value) then
  begin
    CancelEditNode;
...
begin
  ...
  Assert(FNodeDataSize >= SizeOf(Pointer),
    Self.Classname + ': Cannot set initial user data because there is not enough user data space allocated.');
...
begin
  ...
  else if FRoot.ChildCount <> Value then
  begin
    BeginUpdate;
    InterruptValidation;
...
begin
  ...
  begin
    ...
    begin
      ...
      if ((FFocusedColumn < 0) or not(coVisible in FHeader.Columns[FFocusedColumn].Options)) and (FHeader.MainColumn > NoColumn) then
...
// ----------------------------------------------------------------------------------------------------------------------
procedure TBaseVirtualTree.PrepareBackGroundPicture(Source : TVTBackground; DrawingBitmap : TBitmap; DrawingBitmapWidth : TDimension;
  DrawingBitmapHeight : TDimension; ABkgcolor : TColor);
const
...
begin
  ...
  if (Source.Graphic is TBitmap) and (FBackgroundImageTransparent or Source.Bitmap.Transparent) then
  begin
    FillDrawBitmapWithBackGroundColor;
    MaskBlt(DrawingBitmap.Canvas.Handle, 0, 0, Source.Width, Source.Height, Source.Bitmap.Canvas.Handle, 0, 0, Source.Bitmap.MaskHandle, 0,
      0, MakeROP4(DST, SRCCOPY));
  end
  else
  begin
...
procedure TBaseVirtualTree.StaticBackground(Source : TVTBackground; Target : TCanvas; OffsetPosition : TPoint; R : TRect;
  ABkgcolor : TColor);
...
begin
  ...
  try
    ...
    begin
      ...
      BitBlt(Target.Handle, DrawRect.Left - OffsetPosition.X, DrawRect.Top - OffsetPosition.Y,
        (DrawRect.Right - OffsetPosition.X) - (DrawRect.Left - OffsetPosition.X), (DrawRect.Bottom - OffsetPosition.Y) -
        (DrawRect.Top - OffsetPosition.Y) + R.Top, DrawingBitmap.Canvas.Handle, DrawRect.Left - PicRect.Left,
        DrawRect.Top - PicRect.Top, SRCCOPY);
    end;
  finally
    DrawingBitmap.Free;
  end;
...
var
  SourceX, SourceY, TargetX, DeltaY : TDimension;
  DrawingBitmap : TBitmap;
begin
  DrawingBitmap := TBitmap.Create;
  try
    ...
    begin
      ...
      begin
        ...
        begin
          BitBlt(Handle, TargetX, R.Top, Min(R.Right - TargetX, Source.Width - SourceX), DeltaY, DrawingBitmap.Canvas.Handle, SourceX,
            SourceY, SRCCOPY);
...
var
  NodeRect : TRect;
  SpanColumn, Dummy, ColLeft, ColRight : Integer;
  HitInfo : THitInfo;
  ShowOwnHint : Boolean;
...
begin
  ...
  begin
    ...
    if (GetCapture = 0) and ShowHint and not(Dragging or IsMouseSelecting) and ([tsScrolling] * FStates = []) and (FHeader.States = []) and IsFocusedOrEditing
    then
    begin
      with HintInfo^ do
      begin
        ...
        begin
          ...
          if (HitInfo.HitColumn > NoColumn) and not(csLButtonDown in ControlState) and (FHeader.Columns[HitInfo.HitColumn].Hint <> '') then
            HintStr := FHeader.Columns[HitInfo.HitColumn].Hint;
        end
        else if HintMode = hmDefault then
          HintStr := GetShortHint(Hint)
        else if Assigned(HitInfo.HitNode) and (HitInfo.HitColumn > InvalidColumn) then
        begin
              ...
              begin
                ...
                begin
                  ...
                  begin
                    ...
                    ShowOwnHint := (HitInfo.HitColumn > InvalidColumn) and PtInRect(NodeRect, CursorPos) and (CursorPos.X <= ColRight) and
                      (CursorPos.X >= ColLeft) and (
                      ...
                      (NodeRect.Left < Max(ColLeft, 0)) or ((NodeRect.Bottom + BottomRightCellContentMargin.Y) > ClientHeight) or
                      (NodeRect.Top < 0));
                  end;
...
const
  StateMask = TVIS_STATEIMAGEMASK or TVIS_OVERLAYMASK or TVIS_EXPANDED or TVIS_DROPHILITED or TVIS_CUT or TVIS_SELECTED or TVIS_FOCUSED;
...
begin
  ...
  DoStateChange([], [tsClearPending, tsEditPending, tsOLEDragPending, tsVCLDragPending, tsDrawSelecting, tsDrawSelPending,
...
var
  Shift : TShiftState;
  Node, Temp, LastFocused : PVirtualNode;
  Offset : Integer;
  ClearPending, NeedInvalidate, DoRangeSelect, PerformMultiSelect : Boolean;
  Context : Integer;
  ParentControl : TWinControl;
  R : TRect;
  NewCheckState : TCheckState;
  TempColumn, NewColumn : TColumnIndex;
  ActAsGrid : Boolean;
  ...
  var
    PrevColumn : Integer;
  begin
    if (not Assigned(anode)) or (not FHeader.UseColumns) or (not(toAutoSpanColumns in FOptions.AutoOptions)) or
      (acolumn = FHeader.MainColumn) then
    begin
    ...
    begin
      ...
      repeat
        ...
        if (Result = InvalidColumn) or (not ColumnIsEmpty(anode, Result))
...
begin
  ...
  begin
    ...
    begin
      if (CharCode in [VK_HOME, VK_END, VK_PRIOR, VK_NEXT, VK_UP, VK_DOWN, VK_LEFT, VK_RIGHT, VK_BACK, VK_TAB]) and
        (RootNode.FirstChild <> nil) then
      begin
        ...
        ClearPending := (Shift = []) or (ActAsGrid and not(ssShift in Shift)) or not(toMultiSelect in FOptions.SelectionOptions) or
          (CharCode in [VK_TAB, VK_BACK]);
        ...
        case CharCode of
            ...
            begin
              ...
              begin
                ...
                begin
                  ...
                  if (TempColumn <= NoColumn) or (Offset + NewWidth >= ClientWidth) or (coFixed in FHeader.Columns[TempColumn].Options) then
                    Break;
          ...
          VK_UP :
            begin
              ...
              begin
                ...
                else if Assigned(FFocusedNode) then
                  InvalidateNode(FFocusedNode);
              end;
            end;
          VK_DOWN :
          ...
          VK_LEFT :
            begin
              ...
              begin
                ...
                else if Assigned(FFocusedNode) and (vsExpanded in FFocusedNode.States) and (Shift = []) and
                  (vsHasChildren in FFocusedNode.States) then
                    ...
                    begin
                      ...
                      begin
                        ...
                        if FFocusedNode.Index > 0 then
                          DoRangeSelect := True
                        else if CompareNodePositions(Node, FRangeAnchor) > 0 then
          ...
          VK_RIGHT :
            begin
              ...
              begin
                ...
                else if Assigned(FFocusedNode) and not(vsExpanded in FFocusedNode.States) and (Shift = []) and
                  (vsHasChildren in FFocusedNode.States) then
                  ToggleNode(FFocusedNode)
                else
                begin
          ...
          VK_BACK :
            if tsIncrementalSearching in FStates then
              DoStateChange([tsIncrementalSearchPending])
            else if Assigned(FFocusedNode) and (FFocusedNode.Parent <> FRoot) then
        ...
        begin
          ...
          else if (LastFocused <> FFocusedNode) then
          begin
      ...
      begin
        ...
        case CharCode of
          ...
          VK_ADD :
            ...
            begin
              if ssCtrl in Shift then
              begin // When changing this code review issue #781
          ...
          VK_SUBTRACT :
            ...
            begin
              ...
              else if Assigned(FFocusedNode) and (vsExpanded in FFocusedNode.States) then
                ToggleNode(FFocusedNode);
            end
            else
              DoStateChange([tsIncrementalSearchPending]);
          ...
          VK_SPACE :
            if (toCheckSupport in FOptions.MiscOptions) and Assigned(FFocusedNode) and (FFocusedNode.CheckType <> ctNone) then
            begin
...
begin
  ...
  DoStateChange([], [tsScrollPending, tsScrolling, tsEditPending, tsLeftButtonDown, tsRightButtonDown, tsMiddleButtonDown, tsOLEDragPending,
    tsVCLDragPending, tsIncrementalSearching, tsNodeHeightTrackPending, tsNodeHeightTracking]);
...
begin
  inherited;
  if (hoVisible in FHeader.Options) and FHeader.InHeader(ScreenToClient(SmallPointToPoint(message.Pos))) then
...
begin
  ...
  else if (VclStyleEnabled and not(seBorder in StyleElements)) then
...
begin
  ...
  begin
    ...
    if (CursorWnd = Handle) and ([tsWheelPanning, tsWheelScrolling] * FStates = []) then
    begin
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              if (hiOnItem in HitInfo.HitPositions) and ([hiUpperSplitter, hiLowerSplitter] * HitInfo.HitPositions <> []) then
              begin
...
var
  Name : string;
  NewCursor : HCURSOR;
  ScrollHorizontal, ScrollVertical : Boolean;
    ...
    begin
      ...
      begin
        ...
        if Y - FLastClickPos.Y < -8 then
          name := 'VT_MOVENW'
        else if Y - FLastClickPos.Y > 8 then
          name := 'VT_MOVESW'
        else
          name := 'VT_MOVEW';
      end
      else if X - FLastClickPos.X > 8 then
      begin
        // Right hand side.
        if Y - FLastClickPos.Y < -8 then
          name := 'VT_MOVENE'
...
var
  StepSize, RemainingTime, RemainingSteps, NextTimeStep, CurrentStep, StartTime : Cardinal;
  CurrentTime : Int64;
...
begin
  ...
  Result := ((toAutoScroll in FOptions.AutoOptions) or IsWheelPanning) and (FHeader.States = []) and
    (IsDrawSelecting or IsDropTarget or (tsVCLDragging in FStates) or IsWheelPanning);
end;
...
begin
  Result := (toNodeHeightResize in FOptions.MiscOptions) and Assigned(Node) and (Node <> FRoot) and (Column > NoColumn) and
    (coFixed in FHeader.Columns[Column].Options);
  ...
  try
    ...
    begin
      ...
      begin
        ...
        FRoot.TotalHeight := Cardinal(Int64(FRoot.TotalHeight) + Int64(lNewNodeTotalHeight) - Int64(Run.TotalHeight));
        // Avoiding EIntOverflow exception.
...
begin
  ...
  begin
    ...
    else if Run.CheckType in [ctCheckBox, ctTriStateCheckBox] then
    begin
      System.Inc(BoxCount);
  ...
  else if CheckCount < BoxCount then
...
begin
  ...
  if (toReportMode in FOptions.MiscOptions) and not(ItemHit or ((LabelHit or ImageHit) and (HitInfo.HitColumn = FHeader.MainColumn))) then
    HitInfo.HitNode := nil;
  ...
  begin
    if LabelHit or ImageHit or not(toShowDropmark in FOptions.PaintOptions) then
      Result := dmOnNode
    else if Divide(NodeRect.Top + NodeRect.Bottom, 2) > P.Y then
      Result := dmAbove
    else
      Result := dmBelow;
  end
...
procedure TBaseVirtualTree.DetermineHitPositionLTR(var HitInfo : THitInfo; Offset, Right : TDimension; Alignment : TAlignment);

// This method determines the hit position within a node with left-to-right orientation.

var
  MainColumnHit : Boolean;
  lIndent, TextWidth, ImageOffset : TDimension;
  lOffsets : TVTOffsets;
begin
              ...
              case Alignment of
                taCenter :
                  begin
                    ...
                    else if Offset < lIndent + TextWidth then
                      Include(HitInfo.HitPositions, hiOnItemLabel)
                    else
...
var
  MainColumnHit : Boolean;
  Run : PVirtualNode;
  Indent, TextWidth, ImageOffset : TDimension;
...
begin
  ...
  begin
    ...
    begin
      ...
      if MainColumnHit and (toCheckSupport in FOptions.MiscOptions) and Assigned(FCheckImages) and (HitInfo.HitNode.CheckType <> ctNone)
      then
                ...
                taCenter :
                  begin
                    ...
                    if Offset < Indent then
                      Include(HitInfo.HitPositions, hiOnItemLeft)
                    else if Offset < Indent + TextWidth then
                      Include(HitInfo.HitPositions, hiOnItemLabel)
                    else
                      Include(HitInfo.HitPositions, hiOnItemRight);
                  end;
...
begin
  ...
  if (toShowTreeLines in FOptions.PaintOptions) and (not(toHideTreeLinesIfThemed in FOptions.PaintOptions) or not(tsUseThemes in FStates))
  then
  begin
    ...
    begin
      ...
      if (toShowRoot in FOptions.PaintOptions) and
        ((toShowTreeLines in FOptions.PaintOptions) and (not(toHideTreeLinesIfThemed in FOptions.PaintOptions) or
  ...
  if (tsUseExplorerTheme in FStates) and HasChildren[Node] and (Indent >= 0) and
...
begin
  case CheckType of
    ctTriStateCheckBox, ctButton, ctCheckBox :
      begin
...
begin
  ...
  begin
    ...
    begin
      ...
      if (Result <> []) and ((Assigned(FDragManager) and DragManager.IsDropTarget) or (FindDragTarget(Point(X, Y), False) = Self)) then
      begin
...
procedure TBaseVirtualTree.DoBeforeCellPaint(Canvas : TCanvas; Node : PVirtualNode; Column : TColumnIndex; CellPaintMode : TVTCellPaintMode;
...
procedure TBaseVirtualTree.DoCanSplitterResizeNode(P : TPoint; Node : PVirtualNode; Column : TColumnIndex; var Allowed : Boolean);
...
begin
  StopTimer(ExpandTimer);
  if Assigned(FDropTargetNode) and (vsHasChildren in FDropTargetNode.States) and not(vsExpanded in FDropTargetNode.States) then
  begin
...
begin
  ...
  StopTimer(EditTimer);
  DoStateChange([], [tsEditPending]);
  if Assigned(FFocusedNode) and not(vsDisabled in FFocusedNode.States) and not(toReadOnly in FOptions.MiscOptions) and (FEditLink = nil)
  then
  begin
    ...
    begin
      DoStateChange([tsEditing], [tsDrawSelecting, tsDrawSelPending, tsToggleFocusedSelection, tsOLEDragPending, tsOLEDragging,
...
begin
  ...
  begin
    ...
    begin
      ...
      if FHeader.UseColumns and (not FHeader.Columns.IsValidColumn(FFocusedColumn)) and FHeader.AllowFocus(FHeader.MainColumn) then
        FFocusedColumn := FHeader.MainColumn;
      ...
      if (FUpdateCount = 0) and not(toDisableAutoscrollOnFocus in FOptions.AutoOptions) then
        ScrollIntoView(FFocusedNode, (toCenterScrollIntoView in FOptions.SelectionOptions) and (MouseButtonDown * FStates = []),
...
function TBaseVirtualTree.DoGetImageIndex(Node : PVirtualNode; Kind : TVTImageKind; Column : TColumnIndex; var Ghosted : Boolean;
...
begin
  ...
  Assert((index < 0) or Assigned(Result), 'An image index was supplied for TVTImageKind.' + cTVTImageKind2String[Kind] +
    ' but no image list was supplied.');
...
procedure TBaseVirtualTree.DoGetImageText(Node : PVirtualNode; Kind : TVTImageKind; Column : TColumnIndex; var ImageText : string);
...
function TBaseVirtualTree.DoGetNodeHint(Node : PVirtualNode; Column : TColumnIndex; var LineBreakStyle : TVTToolTipLineBreakStyle) : string;
...
function TBaseVirtualTree.DoNodeHeightDblClickResize(Node : PVirtualNode; Column : TColumnIndex; Shift : TShiftState; P : TPoint) : Boolean;
...
function TBaseVirtualTree.DoNodeHeightTracking(Node : PVirtualNode; Column : TColumnIndex; Shift : TShiftState; var TrackPoint : TPoint;
P : TPoint) : Boolean;
...
begin
  if FLastDropMode in [dmAbove, dmBelow] then
    ...
    begin
      ...
      begin
        Polygon([Point(R.Left + 2, R.Top), Point(R.Right - 2, R.Top), Point(R.Right - 2, R.Top + 6), Point(R.Right - 6, R.Top + 2),
          Point(R.Left + 6, R.Top + 2), Point(R.Left + 2, R.Top + 6)]);
      end
      else
        Polygon([Point(R.Left + 2, R.Bottom - 1), Point(R.Right - 2, R.Bottom - 1), Point(R.Right - 2, R.Bottom - 8),
          Point(R.Right - 7, R.Bottom - 3), Point(R.Left + 7, R.Bottom - 3), Point(R.Left + 2, R.Bottom - 8)]);
          ...
          for I := 0 to ControlCount - 1 do
            ...
            begin
              with Controls[I] as TWinControl do
                DWPStructure := DeferWindowPos(DWPStructure, Handle, 0, Left + DeltaX, Top + DeltaY, 0, 0, SWP_NOZORDER or SWP_NOACTIVATE or
                  SWP_NOSIZE);
      ...
      begin
        ...
        begin
          ...
          if (suoRepaintHeader in Options) and (hoVisible in FHeader.Options) then
            FHeader.Invalidate(nil);
          if not(tsSizing in FStates) and (FScrollBarOptions.ScrollBars in [System.UITypes.TScrollStyle.ssHorizontal,
            System.UITypes.TScrollStyle.ssBoth]) then
...
var
  ActualEnter, ActualLeave : TVirtualTreeStates;
...
begin
  ...
  Assert(FStates * [tsUseCache, tsValidationNeeded] <> [tsUseCache, tsValidationNeeded],
    'Invalid state. tsUseCache and tsValidationNeeded are mutually exclusive and must not be set at the same time');
end;
...
var
  EntryCount, Index : Cardinal;
  CurrentNode, Temp : PVirtualNode;
...
function TBaseVirtualTree.DragDrop(const DataObject : TVTDragDataObject; KeyState : Integer; Pt : TPoint; var Effect : Integer) : HResult;
    ...
    begin
      ...
      begin
        ...
        if (hiOnItemLabel in HitInfo.HitPositions) or
          ((hiOnItem in HitInfo.HitPositions) and ((toFullRowDrag in FOptions.MiscOptions)
          { or (toFullRowSelect in FOptions.SelectionOptions) } )) then
          FLastDropMode := dmOnNode
        else if ((R.Top + R.Bottom) div 2) > Pt.Y then
...
function TBaseVirtualTree.DragOver(Source : TObject; KeyState : Integer; DragState : TDragState; Pt : TPoint; var Effect : Integer)
  : HResult;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        if (toAutoDropExpand in FOptions.AutoOptions) and Assigned(FDropTargetNode) and (vsHasChildren in FDropTargetNode.States) then
...
begin
  R := Rect(Min(Left, Right), Top, Max(Left, Right) + 1, Top + 1);
  StyleServices.DrawElement(PaintInfo.Canvas.Handle, StyleServices.GetElementDetails(tlGroupHeaderLineOpenSelectedNotFocused), R, @R,
    CurrentPPI);
end;
...
begin
  R := Rect(Left, Min(Top, Bottom), Left + 1, Max(Top, Bottom) + 1);
  if pFixedColumn and (TVTPaintOption.toShowVertGridLines in TreeOptions.PaintOptions) then
  // In case we showe grid lines, we must use a color for the fixed column that differentiates from the normal gridlines
...
begin
  if IsEmpty then
    Exit; // Nothing to do
  if (toAlwaysSelectNode in TreeOptions.SelectionOptions) or (pAfterDeletion and (toSelectNextNodeOnRemoval in TreeOptions.SelectionOptions))
  then
  begin
...
function TBaseVirtualTree.FindNodeInSelection(P : PVirtualNode; var Index : Integer; LowBound, HighBound : Integer) : Boolean;
...
function TBaseVirtualTree.GetCheckImage(Node : PVirtualNode; ImgCheckType : TCheckType = ctNone;
ImgCheckState : TCheckState = csUncheckedNormal; ImgEnabled : Boolean = True) : Integer;
...
begin
  ...
  if ImgCheckState.IsDisabled then
  begin // disabled image?
  ...
  if IsHot and (ImgCheckState in [csCheckedNormal, csUncheckedNormal]) and (GetKeyState(VK_LBUTTON) < 0) and
    (hiOnItemCheckBox in FLastHitInfo.HitPositions) then
...
function TBaseVirtualTree.GetImageSize(Node : PVirtualNode; Kind : TVTImageKind = TVTImageKind.ikNormal; Column : TColumnIndex = 0;
IncludePadding : Boolean = True) : TSize;
...
begin
  if not Assigned(OnGetImageIndexEx) and (((Kind = TVTImageKind.ikNormal) and not Assigned(FImages)) or
    ((Kind = TVTImageKind.ikState) and not Assigned(FStateImages))) then
  begin
    Result.cx := 0;
    Result.cy := 0;
  end;
...
var
  ...
  ButtonIsHit, DoInvalidate : Boolean;
...
begin
  ...
  if (CheckPositions * HitInfo.HitPositions = []) and (not(toFullRowSelect in FOptions.SelectionOptions) or
    (hiNowhere in HitInfo.HitPositions)) then
    FCurrentHotNode := nil
  else
  ...
  else if not Assigned(HitInfo.HitNode) then
...
var
  ...
  SingleLetter, PreviousSearch : Boolean; // True if VK_BACK was sent.
...
begin
  ...
  begin
    ...
    Node := nil;
    if (hiOnItem in HitInfo.HitPositions) and (HitInfo.HitColumn > NoColumn) and (coFixed in FHeader.Columns[HitInfo.HitColumn].Options)
    then
    begin
      if hiUpperSplitter in HitInfo.HitPositions then
        Node := GetPreviousVisible(HitInfo.HitNode, True)
  ...
  if MayEdit and Assigned(FFocusedNode) and (FFocusedNode = HitInfo.HitNode) and (FFocusedColumn = HitInfo.HitColumn) and
...
var
  ...
  var
    ...
    Dummy : TColumnIndex;
  begin
    if (not FHeader.UseColumns) or (not(toAutoSpanColumns in FOptions.AutoOptions)) or (acolumn = FHeader.MainColumn) then
    begin
    ...
    begin
      ...
      repeat
        ...
        Dummy := GetNextVisibleColumn(NextColumn);
        if (Dummy = InvalidColumn) or not ColumnIsEmpty(anode, Dummy) or (Items[Dummy].BidiMode <> bdLeftToRight) then
          Break;
        NextColumn := Dummy;
      until False;
    end;
...
begin
  ...
  if (hiOnItemLabel in HitInfo.HitPositions) or (toFullRowSelect in FOptions.SelectionOptions) or (toGridExtensions in FOptions.MiscOptions)
  then
  begin
  ...
  IsCellHit := not IsLabelHit and Assigned(HitInfo.HitNode) and ([hiOnItemButton, hiOnItemCheckBox, hiNowhere] * HitInfo.HitPositions = [])
    and ((toFullRowSelect in FOptions.SelectionOptions) or ((toGridExtensions in FOptions.MiscOptions) and (HitInfo.HitColumn > NoColumn)));
  ...
  begin
    ...
    FullRowDrag := (toFullRowDrag in FOptions.MiscOptions) and IsCellHit and not(hiNowhere in HitInfo.HitPositions) and
  ...
  IsHeightTracking := (message.Msg = WM_LBUTTONDOWN) and (hiOnItem in HitInfo.HitPositions) and
  ...
  with HitInfo, message do
    CanClear := not AutoDrag and (not(tsRightButtonDown in FStates) or not HasPopupMenu(HitNode, HitColumn, Point(XPos, YPos)));

  // pending clearance
  if MultiSelect and ShiftEmpty and not(hiOnItemCheckBox in HitInfo.HitPositions) and IsAnyHit and AutoDrag and NodeSelected and not FSelectionLocked
  then
  ...
  if not FSelectionLocked and ((not(IsAnyHit or FullRowDrag) and MultiSelect and ShiftEmpty) or
    (IsAnyHit and (not NodeSelected or (NodeSelected and CanClear)) and (ShiftEmpty or not MultiSelect or (tsRightButtonDown in FStates))))
  then
  begin
    ...
    if NodeSelected or (AltPressed and Assigned(HitInfo.HitNode) and (HitInfo.HitColumn = FHeader.MainColumn)) and
      not(hiNowhere in HitInfo.HitPositions) then
    begin
  ...
  // pending node edit
  if Focused and ((hiOnItemLabel in HitInfo.HitPositions) or ((toGridExtensions in FOptions.MiscOptions) and
    (hiOnItem in HitInfo.HitPositions))) and NodeSelected and not NewColumn and ShiftEmpty and (SelectedCount = 1) then
  begin
    DoStateChange([tsEditPending]);
  end;

  if not(toDisableDrawSelection in FOptions.SelectionOptions) and not(IsLabelHit or FullRowDrag) and
    (MultiSelect or (hiNowhere in HitInfo.HitPositions)) then
  begin
  ...
  if (IsLabelHit or IsCellHit) and DoFocusChanging(FFocusedNode, HitInfo.HitNode, FFocusedColumn, Column) then
  begin
    if NewColumn then
    begin
    ...
    begin
      ScrollIntoView(FFocusedNode, False, not(toDisableAutoscrollOnFocus in FOptions.AutoOptions) and
        not(toFullRowSelect in FOptions.SelectionOptions));
...
begin
  ...
  begin
    ...
    // Prevent AV when dereferencing HitInfo.HitNode below, see bug #100
    begin
    ...
    DoStateChange([], [tsOLEDragPending, tsOLEDragging, tsClearPending, tsDrawSelPending, tsToggleFocusedSelection, tsScrollPending,
      tsScrolling]);
    StopTimer(ScrollTimer);
    ...
    if FLastHitInfo.HitNode <> nil then
    begin // Use THitInfo of mouse down here, see issue #692
      DoNodeClick(FLastHitInfo);
      if Assigned(FLastHitInfo.HitNode) then
      begin
    ...
    begin
      ...
      if (HitInfo.HitNode = FFocusedNode) and (hiOnItem in HitInfo.HitPositions) and (toEditOnClick in FOptions.MiscOptions) and
  ...
  begin
    ...
    try
      ...
      begin
        ...
        if ((ParentCheckState = csCheckedNormal) or (ParentCheckState = csUncheckedNormal)) and (not SelfCheckState.IsDisabled()) and
          (SelfCheckState <> ParentCheckState) and (Parent <> FRoot) then
...
function TBaseVirtualTree.InternalAddToSelection(const NewItems : TNodeArray; NewLength : Integer; ForceInsert : Boolean) : Boolean;
...
var
  I, J : Integer;
  CurrentEnd : Integer;
  Constrained, SiblingConstrained : Boolean;
...
procedure TBaseVirtualTree.InternalConnectNode(Node, Destination : PVirtualNode; Target : TBaseVirtualTree; Mode : TVTNodeAttachMode);
...
begin
  ...
  begin
    ...
    begin
      ...
      if DoNodeHeightTracking(FHeightTrackNode, FHeightTrackColumn, TVTHeaderCracker(FHeader).GetShiftState, FHeightTrackPoint, Point(X, Y))
      then
      begin
    ...
    if (tsOLEDragPending in FStates) and (((Abs(FLastClickPos.X - X) >= FDragThreshold) and (X > 0)) or // Check >0 to fix issue #833
      ((Abs(FLastClickPos.Y - Y) >= FDragThreshold) and (Y > 0))) then
...
begin
  ...
  begin
    ...
    else if AComponent = FStateImages then
    begin
      StateImages := nil;
      if not(csDestroying in ComponentState) then
        Invalidate;
    end
    else if AComponent = FCustomCheckImages then
    begin
      CustomCheckImages := nil;
      FCheckImageKind := ckSystemDefault;
      if not(csDestroying in ComponentState) then
    ...
    else if AComponent = PopupMenu then
      PopupMenu := nil
    else
      ...
      begin
        if AComponent = FHeader.Images then
          FHeader.Images := nil
        else if AComponent = FHeader.PopupMenu then
...
begin
  ...
  begin
    ...
    begin
      DrawEdge(DC, RC, InnerStyles[BevelInner] or OuterStyles[BevelOuter], Byte(BevelEdges) or EdgeStyles[BevelKind] or Ctl3DStyles[Ctl3D]);
  ...
  begin
    ...
    begin
      ...
      case index of
        ...
        6 :
          Details := StyleServices.GetElementDetails(tbRadioButtonCheckedHot);
        7 :
          Details := StyleServices.GetElementDetails(tbRadioButtonCheckedPressed);
        8 :
          Details := StyleServices.GetElementDetails(tbRadioButtonCheckedDisabled);
        ...
        16 :
          Details := StyleServices.GetElementDetails(tbCheckBoxCheckedDisabled);
        17 :
          Details := StyleServices.GetElementDetails(tbCheckBoxMixedNormal);
        18 :
          Details := StyleServices.GetElementDetails(tbCheckBoxMixedHot);
        19 :
          Details := StyleServices.GetElementDetails(tbCheckBoxMixedPressed);
        20 :
          Details := StyleServices.GetElementDetails(tbCheckBoxMixedDisabled);
        // ctButton
        ckButtonNormal :
      ...
      begin
        ...
        begin
          lSizeDetails := StyleServices.GetElementDetails(tbCheckBoxCheckedNormal);
          // Size of dropdown button should be based on size of checkboxes
      ...
      begin
        if (index in [ckButtonNormal .. ckButtonDisabled]) or not StyleServices.GetElementSize(Canvas.Handle, Details,
          TElementSize.esActual, lSize{$if CompilerVersion >= 34}, CurrentPPI{$ifend}) then
        begin
          // radio buttons fail in RAD Studio 10 Seattle and lower, fallback to checkbox images. See issue #615
          if not StyleServices.GetElementSize(Canvas.Handle, StyleServices.GetElementDetails(tbCheckBoxUncheckedNormal),
            TElementSize.esActual, lSize{$if CompilerVersion >= 34}, CurrentPPI{$ifend}) then
        ...
        Canvas.Refresh;
        // Every time you give a Canvas.Handle away to some other code you can't control you have to call Canvas.Refresh afterwards because the Canvas object and the HDC can be out of sync.
      end;
      if (index in [ckButtonNormal .. ckButtonDisabled]) then
      begin
        Canvas.Pen.Color := clGray;
        // These constants have been determined by test using various themes and dpi-scalings
        DrawArrow(Canvas, TScrollDirection.sdDown, Point(R.Left + Round(lSize.cx * 0.22), R.Top + Round(lSize.cy * 0.33)),
          Round(lSize.cx * 0.28));
      end; // if
    end
    else
      ...
      begin
        ...
        ImageList_DrawEx(Handle, index, Canvas.Handle, XPos, YPos, 0, 0, GetRGBColor(BkColor), ForegroundColor, ILD_TRANSPARENT);
      end;
  end;
end;
...
var
  ...
  DrawEnabled : Boolean;
  CustomOverlayDrawing : Boolean;
  // False if the built-in overloay drawing of TImageList should be used, True if custom drawing should take place.
begin
  with PaintInfo do
  begin
    ...
    begin
      ...
      if (ImageInfo[iiOverlay].Index > -1) then
      begin
      ...
      // ... or it is not the check image and the node is selected (but selection is not for the entire row)...
        ((vsSelected in Node.States) and not(toFullRowSelect in FOptions.SelectionOptions) and
...
begin
  ...
  begin
    ...
    case FLineMode of
        ...
        begin
          ...
          begin
            if (vsExpanded in Node.States) and not(vsAllChildrenHidden in Node.States) then
              ...
              case LineImage[I] of
                ltRight, ltBottomRight, ltTopDownRight, ltTopRight :
          ...
          begin
            ...
            DrawLineImage(PaintInfo, XPos, CellRect.Top, NodeHeight[Node] - 1, VAlign - 1, NewStyles[I], BidiMode <> bdLeftToRight);
            Inc(XPos, Offset);
          end;
        end;
    else // lmNormal
      ...
      begin
        DoBeforeDrawLineImage(PaintInfo.Node, I + Ord(not(toShowRoot in TreeOptions.PaintOptions)), XPos);
        DrawLineImage(PaintInfo, XPos, CellRect.Top, NodeHeight[Node], VAlign - 1, LineImage[I], BidiMode <> bdLeftToRight);
        Inc(XPos, Offset);
      end;
    end;
  end;
...
var
  BlendRect : TRect;
  TextColorBackup, BackColorBackup : COLORREF; // used to restore forground and background colors when drawing a selection rectangle
...
var
  TextColorBackup, BackColorBackup : COLORREF;
  FocusRect, InnerRect : TRect;
  RowRect : TRect;
  Theme : HTHEME;
const
  TREIS_HOTSELECTED = 6;
  ...
  begin
    ...
    if R.Right > MaxWidth then
      R.Right := MaxWidth;
    AlphaBlend(0, PaintInfo.Canvas.Handle, R, Point(0, 0), bmConstantAlphaAndColor, FSelectionBlendFactor, ColorToRGB(Color));
  end;
...
begin
  ...
  begin
        ...
        begin
          ...
          begin
            ...
            if not IsRectEmpty(InnerRect) then
              ...
              else if (toUseBlendedSelection in FOptions.PaintOptions) then
    ...
    if (tsUseExplorerTheme in FStates) and (toHotTrack in FOptions.PaintOptions) and (Node = FCurrentHotNode) and
      ...
      DrawBackground(IfThen((vsSelected in Node.States) and not(toAlwaysHideSelection in FOptions.PaintOptions), TREIS_HOTSELECTED,
        TREIS_HOT));

    if (Column = FFocusedColumn) or (toFullRowSelect in FOptions.SelectionOptions) then
    begin
      // draw focus rect
      if (poDrawFocusRect in PaintOptions) and (Focused or (toPopupMode in FOptions.PaintOptions)) and (FFocusedNode = Node) and
        ((Column = FFocusedColumn) or (not(toExtendedFocus in FOptions.SelectionOptions) and (toFullRowSelect in FOptions.SelectionOptions)
        and (tsUseExplorerTheme in FStates))) then
      begin
        ...
        if not(toExtendedFocus in FOptions.SelectionOptions) and (toFullRowSelect in FOptions.SelectionOptions) and
          ...
          FocusRect := RowRect
        else if toGridExtensions in FOptions.MiscOptions then
          FocusRect := CellRect
        else
          FocusRect := InnerRect;
...
function TBaseVirtualTree.ReadChunk(Stream : TStream; Version : Integer; Node : PVirtualNode; ChunkType, ChunkSize : Integer) : Boolean;
...
var
  NodeFrom, NodeTo, LastAnchor : PVirtualNode;
  Index : Integer;
...
begin
  ...
  begin
    ...
    else if not FullyVisible[StartNode] then
    begin
...
var
  PanningWindowClass : TWndClass = (Style : 0; lpfnWndProc : @DefWindowProc; cbClsExtra : 0; cbWndExtra : 0; HInstance : 0; hIcon : 0;
  HCURSOR : 0; hbrBackground : 0; lpszMenuName : nil; lpszClassName : 'VTPanningWindow');
      ...
      begin
        ...
        begin
          ...
          if (Start = -1) and (Pixels[X, Y] <> clFuchsia) then
            Start := X
          else if (Start > -1) and (Pixels[X, Y] = clFuchsia) then
          begin
...
begin
  ...
  FPanningWindow := CreateWindowEx(WS_EX_TOOLWINDOW, PanningWindowClass.lpszClassName, nil, WS_POPUP, Pt.X - 16, Pt.Y - 16, 32, 32, Handle,
    0, HInstance, nil);
...
function TBaseVirtualTree.SuggestDropEffect(Source : TObject; Shift : TShiftState; Pt : TPoint; AllowedEffects : Integer) : Integer;
...
begin
  ...
  // Consider borders...
  if HandleAllocated then
  begin // Prevent preliminary creation of window handle, see issue #933
    Size := GetBorderDimensions();
...
begin
  if (tsEditing in FStates) and Assigned(FFocusedNode) and (FEditColumn < FHeader.Columns.Count) then
  // prevent EArgumentOutOfRangeException
  begin
...
procedure TBaseVirtualTree.UpdateWindowAndDragImage(const Tree : TBaseVirtualTree; TreeRect : TRect;
UpdateNCArea, ReshowDragImage : Boolean);
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        RedrawWindow(nil, NCRegion, RDW_FRAME or RDW_NOERASE or RDW_NOCHILDREN or RDW_INVALIDATE or RDW_VALIDATE or RDW_UPDATENOW);
...
begin
  ...
  {$if CompilerVersion < 35} and not(csDesigning in ComponentState) {$ifend};
  Header.StyleChanged();
end;
...
var
  Header : TChunkHeader;
  LastPosition, ChunkSize : Integer;
  Chunk : TBaseChunk;
  Run : PVirtualNode;
...
begin
  ...
  begin
    ...
    if (ThisID[0] = MagicID[0]) and (ThisID[1] = MagicID[1]) and (ThisID[2] = MagicID[2]) and (ThisID[5] = MagicID[5]) then
    begin
...
begin
  ...
  begin
    ...
    lTextHeight := Canvas.TextHeight('Tg') + {$if CompilerVersion > 31} MulDiv(2, CurrentPPI, 96) {$else} 2 {$ifend};
    // See issue #1205, ScaledPixels(2) may return wrong value here
...
begin
  ...
  else if (FStates * [tsOLEDragPending, tsOLEDragging]) = [] then
  begin
...
begin
  Result := (toEditable in FOptions.MiscOptions) and Enabled and not(toReadOnly in FOptions.MiscOptions) and
    ((Column < 0) or (coEditable in FHeader.Columns[Column].Options));
...
function TBaseVirtualTree.CopyTo(Source : PVirtualNode; Tree : TBaseVirtualTree; Mode : TVTNodeAttachMode; ChildrenOnly : Boolean)
  : PVirtualNode;
...
var
  Run, Mark : PVirtualNode;
  LastTop, LastLeft : TDimension;
  NewSize : Integer;
...
begin
  Assert(Assigned(Node), 'Node must not be nil.');
  Assert((Column > InvalidColumn) and (Column < FHeader.Columns.Count), 'Column must be a valid column index (-1 if no header is shown).');
...
begin
  ...
  begin
    ...
    begin
      ...
      if Result then
        CopyToClipboard
      else if not(toReadOnly in FOptions.MiscOptions) then
      begin
...
function TBaseVirtualTree.GetDisplayRect(Node : PVirtualNode; Column : TColumnIndex; TextOnly : Boolean; Unclipped : Boolean = False;
ApplyCellContentMargin : Boolean = False) : TRect;
...
function TBaseVirtualTree.GetFirstChecked(State : TCheckState = csCheckedNormal; ConsiderChildrenAbove : Boolean = False) : PVirtualNode;
...
begin
  ...
  if Assigned(Result) and (not(vsVisible in Result.States) or (not IncludeFiltered and IsEffectivelyFiltered[Result])) then
...
function TBaseVirtualTree.GetFirstVisibleNoInit(Node : PVirtualNode = nil; ConsiderChildrenAbove : Boolean = True;
IncludeFiltered : Boolean = False) : PVirtualNode;
...
var
  ColLeft, ColRight : TDimension;
  NodeTop : TDimension;
  InitialColumn, NextColumn : TColumnIndex;
  CurrentBidiMode : TBidiMode;
  CurrentAlignment : TAlignment;
  NodeRect : TRect;
...
begin
  ...
  else if X > Max(FRangeX, ClientWidth) then
    Include(HitInfo.HitPositions, hiToRight);

  if Y < 0 then
    Include(HitInfo.HitPositions, hiAbove)
  else if Y > Max(FRangeY, ClientHeight) then
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          else if Y >= (NodeRect.Bottom - FOffsetY - 3) then
...
function TBaseVirtualTree.GetLastInitialized(Node : PVirtualNode = nil; ConsiderChildrenAbove : Boolean = False) : PVirtualNode;
...
begin
  ...
  else if FullyVisible[Node] and (vsExpanded in Node.States) then
    Result := GetLastChild(Node)
  else
    Result := nil;
...
function TBaseVirtualTree.GetLastVisibleNoInit(Node : PVirtualNode = nil; ConsiderChildrenAbove : Boolean = True;
IncludeFiltered : Boolean = False) : PVirtualNode;
...
begin
  ...
  if not ConsiderChildrenAbove or not(toChildrenAbove in FOptions.PaintOptions) then
    ...
    begin
      ...
      // Otherwise use the next last child.
      Next := GetLastChildNoInit(Result);
      if Assigned(Next) and (not(vsVisible in Next.States) or (not IncludeFiltered and IsEffectivelyFiltered[Next])) then
...
var
  Run, LastNode, NextNode : PVirtualNode;
  TextLeft, CurrentWidth : TDimension;
  lOffsets : TVTOffsets;
begin
...
begin
  ...
  until not Assigned(Result) or ((vsVisible in Result.States) and (IncludeFiltered or not IsEffectivelyFiltered[Result]));
end;
...
var
  AbsolutePos, CurrentPos : TDimension;
...
function TBaseVirtualTree.GetPreviousVisibleNoInit(Node : PVirtualNode; ConsiderChildrenAbove : Boolean = True) : PVirtualNode;
...
function TBaseVirtualTree.GetPreviousVisibleSiblingNoInit(Node : PVirtualNode; IncludeFiltered : Boolean = False) : PVirtualNode;
...
function TBaseVirtualTree.VisibleNodes(Node : PVirtualNode; ConsiderChildrenAbove : Boolean; IncludeFiltered : Boolean)
  : TVTVirtualNodeEnumeration;
...
function TBaseVirtualTree.VisibleNoInitNodes(Node : PVirtualNode; ConsiderChildrenAbove : Boolean; IncludeFiltered : Boolean)
  : TVTVirtualNodeEnumeration;
...
procedure TBaseVirtualTree.GetTextInfo(Node : PVirtualNode; Column : TColumnIndex; const AFont : TFont; var R : TRect; var Text : string);
...
begin
  ...
  begin
    if (Node = nil) or (Node = FRoot) then
      Invalidate
    else if (vsInitialized in Node.States) and IsEffectivelyVisible[Node] then
    begin
      R := GetDisplayRect(Node, NoColumn, False);
      if R.Top < ClientHeight then
      begin
...
function TBaseVirtualTree.IterateSubtree(Node : PVirtualNode; Callback : TVTGetNodeProc; Data : Pointer; Filter : TVirtualNodeStates = [];
DoInit : Boolean = False; ChildNodesOnly : Boolean = False) : PVirtualNode;
...
procedure TBaseVirtualTree.MoveTo(Node : PVirtualNode; Tree : TBaseVirtualTree; Mode : TVTNodeAttachMode; ChildrenOnly : Boolean);
...
begin
  ...
  if Allowed and (Mode <> amNoWhere) and Assigned(Source) and (Source <> FRoot) and not(toReadOnly in FOptions.MiscOptions) then
  begin
    // Assume that an empty destination means the root in this (the source) tree.
    if Target = nil then
    begin
    ...
    else if (vsHasChildren in Target.States) and (Target.ChildCount = 0) then
...
procedure TBaseVirtualTree.PaintTree(TargetCanvas : TCanvas; Window : TRect; Target : TPoint; PaintOptions : TVTInternalPaintOptions;
...
var
  DrawSelectionRect, UseBackground, ShowCheckImages, UseColumns, IsMainColumn : Boolean;

  IndentSize, ButtonY : TDimension; // Y position of toggle button within the node's rect
  ...
  MaxRight, ColLeft, ColRight : TDimension;
  ...
  begin
    ...
    try
      ...
      begin
        ...
        if ((FDrawSelectionMode = smBlendedRectangle) or (tsUseThemes in FStates) or (toUseBlendedSelection in FOptions.PaintOptions)) then
      ...
      try
        ...
        UseBackground := (toShowBackground in FOptions.PaintOptions) and Assigned(FBackground.Graphic) and (poBackground in PaintOptions);
        ...
        if (toAlwaysHideSelection in FOptions.PaintOptions) or (not Focused and (toHideSelection in FOptions.PaintOptions)) then
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                ClipCanvas(PaintInfo.Canvas, Rect(0, 0, TargetRect.Right - TargetRect.Left, Min(TargetRect.Bottom - TargetRect.Top,
                  MaximumBottom - TargetRect.Top))); // See issue #579
              end;
              ...
              begin
                ...
                ClearNodeBackground(PaintInfo, UseBackground, True, Rect(Window.Left, TargetRect.Top, Window.Right, TargetRect.Bottom));
                ...
                begin
                  while ((PaintInfo.Column > InvalidColumn) or not UseColumns) and (PaintInfo.CellRect.Left < Window.Right) do
                  begin
                    if UseColumns then
                    begin
                    ...
                    with PaintInfo do
                    begin
                      if (tsEditing in FStates) and (Node = FFocusedNode) and ((Column = FEditColumn) or not UseColumns) then
                        Exclude(PaintOptions, poDrawSelection);
                      if not UseColumns or ((vsSelected in Node.States) and (toFullRowSelect in FOptions.SelectionOptions) and
                        (poDrawSelection in PaintOptions)) or (coParentColor in Items[PaintInfo.Column].Options) or
                        ((coStyleColor in Items[PaintInfo.Column].Options) and VclStyleEnabled) then
                        ...
                        begin
                          ...
                          begin
                            ...
                            begin
                              if BidiMode = bdLeftToRight then
                              begin
                                DrawGridHLine(PaintInfo, CellRect.Left + PaintInfo.Offsets[ofsCheckBox] - FImagesMargin, CellRect.Right - 1,
                                  CellRect.Bottom - 1);
                              end
                              else
                              begin
                                DrawGridHLine(PaintInfo, CellRect.Left, CellRect.Right - IfThen(toFixedIndent in FOptions.PaintOptions, 1,
                                  IndentSize) * FIndent - 1, CellRect.Bottom - 1);
                              end;
                            end
                            else
                            ...
                            begin
                              ...
                              begin
                                ...
                                begin
                                  ...
                                  begin
                                    DrawGridVLine(PaintInfo, CellRect.Top, CellRect.Bottom, CellRect.Right - 1,
                                      ColumnIsFixed and (NextColumn >= 0));
                                  end;
                          ...
                          begin
                            if (toShowTreeLines in FOptions.PaintOptions) and
                              ...
                              PaintTreeLines(PaintInfo, IfThen(toFixedIndent in FOptions.PaintOptions, 1, IndentSize), LineImage);
                            ...
                            if (toShowButtons in FOptions.PaintOptions) and (vsHasChildren in Node.States) and
                              not((vsAllChildrenHidden in Node.States) and (toAutoHideButtons in TreeOptions.AutoOptions)) and
                              ((toShowRoot in TreeOptions.PaintOptions) or (GetNodeLevel(Node) > 0)) then
                              PaintNodeButton(Canvas, Node, Column, CellRect, Offsets[ofsToggleButton], ButtonY, BidiMode);
                            // Relative X position of toggle button is needed for proper BiDi calculation
                          ...
                          if not((tsEditing in FStates) and (Node = FFocusedNode) and ((Column = FEditColumn) or not UseColumns)) then
                ...
                begin
                  ...
                  if (Node = FDropTargetNode) and (toShowDropmark in FOptions.PaintOptions) and (poDrawDropMark in PaintOptions) then
              ...
              begin
                if DrawSelectionRect then
                begin
                  PaintSelectionRectangle(PaintInfo.Canvas, Window.Left, SelectionRect, Rect(0, 0, PaintWidth, CurrentNodeHeight));
                end;

                // Put the constructed node image onto the target canvas.
                if not(poUnbuffered in PaintOptions) then
                  with NodeBitmap do
                    BitBlt(TargetCanvas.Handle, TargetRect.Left, TargetRect.Top, TargetRect.Width, TargetRect.Height, Canvas.Handle,
                      Window.Left, 0, SRCCOPY);
              end;
            end;
                ...
                begin
                  ...
                  begin
                    ...
                    begin
                      ...
                      if (poGridLines in PaintOptions) and (toFullVertGridLines in FOptions.PaintOptions) and
                  ...
                  begin
                    ...
                    if (poGridLines in PaintOptions) and (toFullVertGridLines in FOptions.PaintOptions) and
                      (toShowVertGridLines in FOptions.PaintOptions) and (not(hoAutoResize in FHeader.Options)) then
                      Inc(R.Left);
                    PaintInfo.Canvas.Brush.Color := FColors.BackGroundColor;
                    PaintInfo.Canvas.FillRect(R);
                  end;
      ...
      begin
        ...
        // Use slightly larger font to attract awareness of user, there is enough space ince the list is empty.
        SetBkMode(TargetCanvas.Handle, Transparent);
        lEmptyListTextMargin := ScaledPixels(Max(cDefaultTextMargin, Self.TextMargin) * 2);
        // Since the list is empty and the font is slightly larger make sure text id not too close at the edges so that it looks good.
...
var
  ...
  TreeRect, PaintRect : TRect;
  LocalSpot, ImagePos, PaintTarget : TPoint;
...
var
  ...
  vPageWidth, vPageHeight, // Printer height in VTree resolution
...
procedure TBaseVirtualTree.DoDrawHint(Canvas : TCanvas; Node : PVirtualNode; R : TRect; Column : TColumnIndex);
...
procedure TBaseVirtualTree.DoGetHintSize(Node : PVirtualNode; Column : TColumnIndex; var R : TRect);
...
procedure TBaseVirtualTree.DoGetHintKind(Node : PVirtualNode; Column : TColumnIndex; var Kind : TVTHintKind);
...
procedure TBaseVirtualTree.ReinitChildren(Node : PVirtualNode; Recursive : Boolean; ForceReinit : Boolean = False);
...
procedure TBaseVirtualTree.ReinitNode(Node : PVirtualNode; Recursive : Boolean; ForceReinit : Boolean = False);
...
begin
  ...
  begin
    ...
    Node.States := Node.States - [vsInitialized, vsChecking, vsCutOrCopy, vsDeleting, vsHasChildren, vsExpanded, vsHeightMeasured];
    InvalidateNode(Node);
  end;
end;
...
var
  R : TRect;
  Run : PVirtualNode;
  UseColumns, HScrollBarVisible : Boolean;
  OldOffsetY : TDimension;
  ScrolledVertically, ScrolledHorizontally : Boolean;

begin
  ScrolledVertically := False;
  ScrolledHorizontally := False;

  if Assigned(Node) and (Node <> FRoot) and HandleAllocated then
  // We don't want to create the handle if it has not yet been created, see issue #897
  begin
    // Make sure all parents of the node are expanded.
    Run := Node.Parent;
    while Run <> FRoot do
    ...
    else if (R.Bottom > ClientHeight) or Center then
    begin
      HScrollBarVisible := (ScrollBarOptions.ScrollBars in [System.UITypes.TScrollStyle.ssBoth, System.UITypes.TScrollStyle.ssHorizontal])
        and (ScrollBarOptions.AlwaysVisible or (FRangeX > ClientWidth));
      if Center then
    ...
    if Horizontally then
      ...
      ScrolledHorizontally := ScrollIntoView(FFocusedColumn,
        Center and (R.Width <= (ClientWidth - Header.Columns.GetVisibleFixedWidth)), Node);
  end;
...
var
  ColumnLeft, ColumnRight : TDimension;
  NewOffset, OldOffset : TDimension;
  R : TRect;

begin
  Result := False;

  if FHeader.UseColumns and FHeader.Columns.IsValidColumn(Column) then
  begin
    ColumnLeft := Header.Columns.Items[Column].Left;
    ColumnRight := ColumnLeft + Header.Columns.Items[Column].Width;
  end
  else if Assigned(Node) and (toCenterScrollIntoView in FOptions.SelectionOptions) then
  begin
    Center := False;
    R := GetDisplayRect(Node, NoColumn, not(toGridExtensions in FOptions.MiscOptions));
    ColumnLeft := R.Left;
  ...
  begin
    if ColumnRight > ClientWidth then
      NewOffset := FEffectiveOffsetX + Min(ColumnRight - ClientWidth, -(Header.Columns.GetVisibleFixedWidth - ColumnLeft))
  ...
  begin
    NewOffset := FEffectiveOffsetX + ColumnLeft - Divide(Header.Columns.GetVisibleFixedWidth, 2) - Divide(ClientWidth, 2) +
      Divide(ColumnRight - ColumnLeft, 2);
    if NewOffset <> FEffectiveOffsetX then
    begin
      if UseRightToLeftAlignment then
        SetOffsetX(-FRangeX + ClientWidth + NewOffset)
...
// --------------- local function --------------------------------------------
  ...
  begin
    ...
    begin
      ...
      // There is no need to sort collapsed branches
        DoSort(Run);
      Run := Run.NextSibling;
    end;
  end;
...
var
  Child, FirstVisible : PVirtualNode;
  HeightDelta, StepsR1, StepsR2 : TDimension;
  Steps : Integer;
  TogglingTree, ChildrenInView, NeedFullInvalidate, NeedUpdate, NodeInView, PosHoldable, TotalFit : Boolean;
    ...
    try
      ...
      begin
        ...
        begin
          ...
          if (FUpdateCount = 0) and (toAnimatedToggle in FOptions.AnimationOptions) and not(tsCollapsing in FStates) then
          begin
            if tsHint in Self.FStates then
              Application.CancelHint;
            UpdateWindow();
            ...
            begin
              ...
              begin
                if (FRangeY + FOffsetY - R1.Bottom + HeightDelta >= ClientHeight - R1.Bottom) or (FRangeY <= ClientHeight) or
                  (FOffsetY = 0) or not(toAdvancedAnimatedToggle in FOptions.AnimationOptions) then
                begin
              ...
              begin
                ...
                begin
                  ...
                  if not(toAdvancedAnimatedToggle in FOptions.AnimationOptions) or
                    (PosHoldable and ((NodeInView and ChildrenInView) or not(toAutoScrollOnExpand in FOptions.AutoOptions))) then
                  begin
                    Mode1 := tamScrollUp;
                  ...
                  begin
                    ...
                    begin
                      ...
                      else if FRangeY + HeightDelta <= ClientHeight then
                      begin
                ...
                begin
                  ...
                  if (PosHoldable and ChildrenInView) or not(toAutoScrollOnExpand in FOptions.AutoOptions) or
                    not(toAdvancedAnimatedToggle in FOptions.AnimationOptions) or (R1.Top <= 0) then
                  begin
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                begin
                  NeedFullInvalidate := True;
                  if (PosHoldable and ChildrenInView and NodeInView) or not(toAutoScrollOnExpand in FOptions.AutoOptions) then
...
begin
  ...
  if (IsUpdating) then
    Exit;
  Assert(GetCurrentThreadId = MainThreadId, 'UI controls like ' + Classname +
    ' and its scrollbars should only be manipulated through the main thread.');
...
begin
  if Node = nil then
    Node := FRoot
  else if not(vsInitialized in Node.States) then
    InitNode(Node);
